...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 min-h-screen flex flex-col`}
      >
        <AuthProvider>
          <FilterProvider>
            <Header languages={supportedLanguages} />
            ...
            <Footer languages={supportedLanguages} />
